                    ...
                    <li class="nav-item mt-3 mt-md-0 ">
                        <a class="nav-link navbar__button text-uppercase " href="#">
                            <svg width="21" height="28" viewBox="0 0 21 28" fill="none"
                                ...
                                <path
                                    d="M16.4 2H4.4C3.07452 2 2 3.07452 2 4.4V23.6C2 24.9255 3.07452 26 4.4 26H16.4C17.7255 26 18.8 24.9255 18.8 23.6V4.4C18.8 3.07452 17.7255 2 16.4 2Z"
                                    stroke="#FAFDFE" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M10.3999 21.2002H10.4119" stroke="#FAFDFE" stroke-width="4"
                    ...
                    <form>
                        <div class="form-row  ">
                            ...
                            <div class="col-12 col-lg-4 ">
                                <button class="btn masthead__button btn-lg mt-2 mt-lg-0 btn-block   text-uppercase ">
                                    Notify me</button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="col-9 col-md-5 masthead__images d-flex justify-content-end mx-auto">
...
-->
            ...
            <div class="row d-flex align-items-center">
                <div class="col-12 col-lg-4 ">
                    <div class="row text-left text-lg-right mb-4">
                        ...
                        <div class="col-3 order-1 order-lg-2">
                    ...
                    <div class="row text-left text-lg-right mb-4 mb-lg-0">
                        ...
                        <div class="col-3 order-1 order-lg-2 ">
                            <img class="mr-4" src="./assets/images/icons/alertIcon.svg" alt="">
                        </div>
                    </div>
                </div>

                <div
                    class="col-6 col-sm-6 col-md-6 col-lg-4  mx-auto  d-flex justify-content-center align-items-center mb-4 mb-lg-0 ">
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="row text-left ">
                        ...
                        <div class="col-9  align-self-center">
                            <p> Makes an emergency call to your provided contact number to rescue you from the situation
                                or discussion.</p>
                        </div>
    ...
    <section id="options" class=" py-5">
        <div class="container">
            ...
            <div class="row">
                <div
                    class="col-12 col-md-5  order-2  d-flex justify-content-center justify-content-md-start   align-items-center ">
                    ...
                    <div>
                        <div class="options__list d-flex flex-column justify-content-around ">
                            <div class="d-flex flex-row align-items-center  mb-4">
                                ...
                                <p class="mb-0 ">
                                    <span class="blue__color"> Customize </span> emergency informations to suit you.
                                </p>
                            </div>
                            <div class="d-flex flex-row align-items-center   mb-4">
                                <img class="mr-4" src="./assets/images/icons/check.svg" alt="">
                                <p class="mb-0 ">
                                    Include top two <span class="blue__color">emergency numbers</span> that RescueCall
                                    will alert incase of emergency
                                    situations. </p>
                            </div>
                            <div class="d-flex flex-row align-items-center  mb-4">
                                <img class="mr-4" src="./assets/images/icons/check.svg" alt="">
                                <p class="mb-0 ">
                                    Pick out how you <span class="blue__color">feel</span> and <span
                                        class="blue__color">act</span> when you’re uncomfortable from a <span
                                        class="blue__color">variety</span> of <span class="blue__color">options</span>.
                                </p>
                            </div>
                            <div class="d-flex flex-row align-items-center   mb-4">
                                <img class="mr-4" src="./assets/images/icons/check.svg" alt="">
                                <p class="mb-0 ">
                                    <span class="blue__color">Accept</span>, <span class="blue__color">decline</span> or
                                    <span class="blue__color">alert</span> your emergency numbers when RescueCall senses
                                    your
                                    discomfort. </p>
                            </div>
                        </div>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide d-flex align-items-center">
                    <div class="sneakpeek__card d-flex">
                        <a href="./assets/images/sneekpeak/g.png" data-lightbox="mygallery" class="d-flex" ><img class="mx-auto" src="./assets/images/sneekpeak/g.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide d-flex align-items-center">
                    <div class="sneakpeek__card d-flex ">
                        <a href="./assets/images/sneekpeak/a.png" data-lightbox="mygallery" class="d-flex"><img class="mx-auto" src="./assets/images/sneekpeak/a.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide d-flex align-items-center">
                    <div class="sneakpeek__card d-flex ">
                        <a href="./assets/images/sneekpeak/b.png" data-lightbox="mygallery" class="d-flex"><img class="mx-auto" src="./assets/images/sneekpeak/b.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide d-flex align-items-center">
                    <div class="sneakpeek__card d-flex">
                        <a href="./assets/images/sneekpeak/c.png" data-lightbox="mygallery" class="d-flex"><img class="mx-auto" src="./assets/images/sneekpeak/c.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide d-flex align-items-center">
                    <div class="sneakpeek__card d-flex">
                        <a href="./assets/images/sneekpeak/d.png" data-lightbox="mygallery" class="d-flex"><img class="mx-auto" src="./assets/images/sneekpeak/d.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide d-flex align-items-center">
                    <div class="sneakpeek__card d-flex">
                        <a href="./assets/images/sneekpeak/f.png" data-lightbox="mygallery" class="d-flex"><img class="mx-auto" src="./assets/images/sneekpeak/f.png" alt=""></a>
                    </div>
                </div>
            </div>
