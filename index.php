...
<body>
    ...
    <section id="functions" class="mb-5 pb-5">
        <span class="functions__title d-flex align-items-center justify-content-center mb-0 mb-lg-5" data-aos="fade-up" data-aos-duration="2000">
    ...
    <section id="options" class=" py-5">
        <div class="container">
            <span class="options__title d-flex align-items-center justify-content-center py-1 mb-0 mb-lg-5" data-aos="fade-up" data-aos-duration="2000">
                <img class="separator" src="./assets/images/icons/separator.svg" alt="">
                    ...
                    <div data-aos="fade-up-left" data-aos-duration="2000">
                        <div class="options__list d-flex flex-column justify-content-around ">
                            ...
                            <div class="d-flex flex-row align-items-center  mb-4">
                                <img class="mr-4" src="./assets/images/icons/check.svg" alt="">
                                <p class="mb-0 ">
                                    Pick out how you <span class="blue__color">feel</span> and <span class="blue__color">act</span> when you’re uncomfortable from a <span class="blue__color">variety</span> of <span class="blue__color">options</span>.
                                </p>
                            </div>
                            <div class="d-flex flex-row align-items-center   mb-4">
                                <img class="mr-4" src="./assets/images/icons/check.svg" alt="">
    ...
    <section id="sneakpeek" class="py-5">
        <span class="options__title d-flex align-items-center justify-content-center mb-0" data-aos="fade-up" data-aos-duration="2000">
            <img class="separator" src="./assets/images/icons/separator.svg" alt="">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide d-flex align-items-center">
                    <div class="sneakpeek__card ">
                        <a href="./assets/images/sneekpeak/6-big.png" data-lightbox="mygallery"  >
                            <img class="mx-auto" src="./assets/images/sneekpeak/6.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide d-flex align-items-center">
                    <div class="sneakpeek__card  ">
                        <a href="./assets/images/sneekpeak/1-big.png" data-lightbox="mygallery"  >
                            <img class="mx-auto" src="./assets/images/sneekpeak/1.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide d-flex align-items-center">
                    <div class="sneakpeek__card ">
                        <a href="./assets/images/sneekpeak/2-big.png" data-lightbox="mygallery"  >
                        <img class="mx-auto" src="./assets/images/sneekpeak/2.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide d-flex align-items-center">
                    <div class="sneakpeek__card ">
                        <a href="./assets/images/sneekpeak/3-big.png" data-lightbox="mygallery"  >
                        <img class="mx-auto" src="./assets/images/sneekpeak/3.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide d-flex align-items-center">
                    <div class="sneakpeek__card">
                        <a href="./assets/images/sneekpeak/4-big.png" data-lightbox="mygallery"  >
                        <img class="mx-auto" src="./assets/images/sneekpeak/4.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide d-flex align-items-center">
                    <div class="sneakpeek__card">
                        <a href="./assets/images/sneekpeak/5-big.png" data-lightbox="mygallery" >
                        <img class="mx-auto" src="./assets/images/sneekpeak/5.png" alt=""></a>
                    </div>
                </div>
            </div>
